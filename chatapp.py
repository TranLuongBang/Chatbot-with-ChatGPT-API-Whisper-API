...
def predict(message):
    ...
    # Send request and get response from chatGPT API
...
def transcribe(audio_file):
    ...
    response = [(audio_history[i]["content"], audio_history[i+1]["content"]) for i in range(0, len(audio_history) - 1, 2)]
